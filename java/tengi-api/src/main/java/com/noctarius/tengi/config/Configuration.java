...
public interface Configuration {
    ...
    public static final class Builder {
        ...
        public Builder addMarshaller(MarshallerFilter marshallerFilter, MarshallerReader reader,
                                     MarshallerWriter writer) {
            marshallers.add(new MarshallerConfiguration(marshallerFilter, marshaller(reader, writer)));
            return this;
        }
        ...
        public Builder addTransport(Transport transport, Transport... transports) {
