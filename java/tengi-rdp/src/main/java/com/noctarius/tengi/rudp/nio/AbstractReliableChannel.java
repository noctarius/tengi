 ...
 * @see DatagramPacket
 */
abstract class AbstractReliableChannel
        extends AbstractNioMessageChannel
        implements ReliableChannel {
     ...
     */
    public AbstractReliableChannel() {
     ...
     */
    public AbstractReliableChannel(SelectorProvider provider) {
     ...
     */
    public AbstractReliableChannel(InternetProtocolFamily ipFamily) {
     ...
     */
    public AbstractReliableChannel(SelectorProvider provider, InternetProtocolFamily ipFamily) {
     ...
     */
    public AbstractReliableChannel(DatagramChannel socket) {
    ...
    public boolean isActive() {
        ...
        return ch.isOpen() && (config.getOption(ChannelOption.DATAGRAM_CHANNEL_ACTIVE_ON_REGISTRATION) && isRegistered() || ch
                .socket().isBound());
    }
    ...
    protected abstract boolean handleSegment(Segment segment, List<Object> buf);

    protected abstract DatagramPacket encodeSegment();
