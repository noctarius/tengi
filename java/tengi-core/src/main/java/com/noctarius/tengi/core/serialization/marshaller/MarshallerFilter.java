...
public interface MarshallerFilter {
     ...
     * the associated {@link Marshaller} is
     * able to serialize and de-serialize this object.</p>
     * <p>If {@link MarshallerFilter.Result#Next} is
     * returned the filter does not assume this object to be serializable using the
     * corresponding {@link Marshaller}. If
     * {@link MarshallerFilter.Result#Accepted} is
     * returned, the corresponding {@link Marshaller}
     * will be able to serialize or de-serialize the object but the result won't be
     * cached. If {@link MarshallerFilter.Result#AcceptedAndCache}
     ...
     *
     * @param object the object to be tested to be serializable using the associated Marshaller
    ...
    public static enum Result {
        /**
         * The {@link MarshallerFilter} does not assume
        ...
        /**
         * The {@link MarshallerFilter} does assume
         * that this object will be serializable using the corresponding
         * {@link Marshaller} <b>but</b> the result will
         ...
         * The {@link MarshallerFilter} does assume
         * that this object will be serializable using the corresponding
         * {@link Marshaller} <b>and</b> the result
