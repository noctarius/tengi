...
package com.github.tengi.client.lang.math
{
     ...
     */ public final class Long implements BigNumber
    {
        ...
        private static function forString( a:Long, value:String, radix:int = 10 ):void
        {
            ...
            var mbi:MutableBigInteger = MutableBigInteger.forString( value,
                                                                     radix ), uints:Uints = mbi.uints, length:int = uints.length;
        ...
        public static function newLong( u1:uint, u0:uint, constants:Boolean = true ):Long
        {
            if ( constants )
            {
                if ( u1 == 0 )
        ...
        public function leftShift( value:uint ):Long
        {
            ...
            // value < 32.
            return newLong( (_u1 << value) | (_u0 >>> (32 - value)), (_u0 << value) );
        }
        ...
        public function rightShift( value:uint, unsigned:Boolean = false ):Long
        {
            ...
            if ( value >= 32 )
            {
                ...
                return newLong( (
                                        (_u1 & 0x80000000) != 0 ? uint.MAX_VALUE : 0), (_u1 >> (value % 32)) );
            }

            // value < 32.
            if ( unsigned )
            {
                return newLong( (_u1 >>> value), (_u0 >>> value) | (_u1 << (32 - value)) );
            }
        ...
        {
            var l:Long = asLong( b ), s0:uint = _u0 + l._u0, s1:uint = _u1 + l._u1;
        ...
        {
            var l:Long = asLong( b ), p:Array = [0, 0], p0:uint = 0, p1:uint = 0;
        ...
        {
            var l:Long = asLong( b ), lsign:int = l.sign, sign:int = this.sign;
            ...
            var left:Long = (sign < 0 ? this.negate() : this), right:Long = (lsign < 0 ? l.negate()
                    : l), comp:int = left.compareTo( right );
            ...
            var q:Long, r:Long, ma:MutableBigInteger, mb:MutableBigInteger, mr:MutableBigInteger;
            ...
            {
                ma = new MutableBigInteger( new Uints( [left._u0, left._u1] ) ), mb =
                        new MutableBigInteger( new Uints( [right._u0, right._u1] ) ), mr = ma.divide( mb );
        ...
        public function compareTo( b:Long ):int
        {
            ...
            const sign:int = this.sign, bSign:int = b.sign;
        ...
        public function toString( radix:int = 10 ):String
        {
            ...
            var radixConstraints:Radix = Radix.getRadix( radix ), sign:int = this.sign, a:Long = (sign < 0
                    ? this.negate() : this);
        ...
        public function  get composite0():uint
        {
            return _u0;
        }

        public function  get composite1():uint
        {
            return _u1;
        }
