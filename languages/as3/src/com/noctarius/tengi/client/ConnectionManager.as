...
package com.noctarius.tengi.client
{
    ...
    import com.noctarius.tengi.client.transport.events.ConnectionEstablishedEvent;
    import com.noctarius.tengi.client.transport.events.ConnectionEvents;
    import com.noctarius.tengi.client.transport.http.HttpConnection;
     ...
     *
     * @eventType com.noctarius.tengi.client.transport.events.ConnectionEstablishedEvent
     */
    [Event(name="CONNECTION_ESTABLISHED", type="com.noctarius.tengi.client.transport.events.ConnectionEstablishedEvent")]

    /**
     * The ConnectionManager is used to create gameserver connections using a {@link com.noctarius.tengi.client.ConnectionConfiguration} object.
     * Using {@link #createConnection()} the ConnectionManager queries the server supported {@link com.noctarius.tengi.client.TransportType}s and a suggested order to try them one by one to find best matching transport and creates a {@link com.noctarius.tengi.client.ClientConnection} using this transport.
